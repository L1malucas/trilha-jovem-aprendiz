...
`pratica.md` (exercícios com critério de aceite e regras de entrega). Todo o conteúdo é markdown
puro por enquanto — a publicação como site (Docusaurus) fica para uma etapa futura.
